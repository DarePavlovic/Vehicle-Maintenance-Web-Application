...
export class UserController {
    ...
    updateUser = (req: express.Request, res: express.Response) => {
        ...
        UserModel.updateOne({ '_id': id }, {
            $set: {
                ...
                'phone': phone_number, 'picture': picture, 'type': type, 'coefficient': coefficient, 'salary': salary
            }
        }).then((err) => {
    ...
    changePassword = (req: express.Request, res: express.Response) => {
        ...
        UserModel.updateOne({ '_id': idUser }, { $set: { 'password': pass } }).then((err) => {
            res.json({ 'message': 'ok' })
    ...
    updateProfile = (req: express.Request, res: express.Response) => {
        ...
        console.log(idUser);
        console.log(email);
        UserModel.updateOne({ '_id': idUser }, { $set: { 'email': email, 'phone': phone, 'address': address, 'picture': picture } }).then((err) => {
            res.json({ 'message': 'ok' })
        });
    }
